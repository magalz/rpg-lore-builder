...
2. Invoque o `rlb-agent-inquisitor` (`validate-entry`) para verificar as adições contra `_bmad/memory/rlb/wiki/`.
...
5. Quando aprovado, crie o arquivo do personagem em `_bmad/memory/rlb/wiki/pcs/` (ou sugira o texto para o Mestre salvar) e atualize os arquivos dos NPCs/Facções relacionados para mencionar o personagem.
